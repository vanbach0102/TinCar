  ...
  <div class="row">
    <div class="col-md-6 col-12">
      <div class="card">
        ...
        <div class="card-body">
				<?php
			if($this->session->flashdata('BrUpSuccess')){
				?>
				<div class="text text-success"><?php echo $this->session->flashdata('BrUpSuccess') ?></div>
				<?php
		...
		?>
          <form class="form form-horizontal" action="<?php echo base_url('brand/update/'.$brand->id) ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="title" onkeyup="ChangeToSlug();" class="form-control" id="title" type="text" placeholder="Title" value="<?php echo $brand->title ?>">
                    </div>
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="slug" class="form-control" id="slug" type="text" placeholder="Slug" value="<?php echo $brand->title ?>">
                    </div>
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="description" class="form-control" id="fname-icon" type="text" placeholder="Description" value="<?php echo $brand->title ?>">
                    </div>
			  ...
			  <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
				<img src="<?php echo base_url('./upload/'.$brand->image) ?>" id="profile-pic" alt="Ảnh">
