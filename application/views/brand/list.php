  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h2 class="card-title"><b>List Brand</b></h2>
      </div>
			
      <div class="card-body">
			<?php
			if($this->session->flashdata('BrDelSuccess')){
				?>
				<div class="text text-success"><?php echo $this->session->flashdata('BrDelSuccess') ?></div>
				<?php
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <button class="btn btn-icon btn-flat-primary" type="button">
				<a href="<?php echo base_url('/brand/edit/'.$value->id) ?>">
				<i class="fa-solid fa-pen-to-square"></i>
				</a>
            </button>
			<button class="btn btn-icon btn-flat-danger" type="button">
				<a onclick="return confirm('Bạn chắc chắn muốn xóa?')" href="<?php echo base_url('/brand/delete/'.$value->id) ?>">
