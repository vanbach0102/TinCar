    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><b>Add Product</b></h2>
        </div>
        <div class="card-body">
				<?php
		...
		?>
          <form class="form form-horizontal" action="<?php echo base_url('product/store') ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="price" class="form-control"  type="number" placeholder="VND">
                    </div>
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="quantity"  class="form-control"  type="text" placeholder="Quantity">
                    </div>
