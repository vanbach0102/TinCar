    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><b>Add Post</b></h2>
        </div>
        <div class="card-body">
				<?php
			if($this->session->flashdata('CateSuccess')){
				?>
				<div class="alert alert-success"><?php echo $this->session->flashdata('CateSuccess') ?></div>
				<?php
		...
		?>
          <form class="form form-horizontal" action="<?php echo base_url('post/store') ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="description" class="form-control" id="fname-icon" type="text" placeholder="Description">
                    </div>
			  ...
			  <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="fname-icon">Content</label>
                  </div>
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      <span class="input-group-text"><i class="fa-solid fa-file-lines"></i></i></span>
			  ...
			  <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="fname-icon">Short content</label>
                  </div>
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      <span class="input-group-text"><i class="fa-solid fa-file-lines"></i></i></span>
			  ...
			  <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="fname-icon">Categroy blog id</label>
                  </div>
                  <div class="col-sm-9">
				  <div class="input-group input-group-merge">
			  ...
			  <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
				<img src="/470x250.png" id="profile-pic" alt="Ảnh">
