    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><b>Add Category</b></h2>
        </div>
        <div class="card-body">
				<?php
			if($this->session->flashdata('CateSuccess')){
				?>
				<div class="text text-success"><?php echo $this->session->flashdata('CateSuccess') ?></div>
				<?php
		...
		?>
          <form class="form form-horizontal" action="<?php echo base_url('category/store') ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
