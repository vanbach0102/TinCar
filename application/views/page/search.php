	...
	<form action="<?php echo base_url('/them-gio-hang') ?>" method="POST">
      <div class="card-body">
        ...
        <hr>
            ...
            <a href="<?php echo base_url('san-pham/'.$pro->id) ?>"><button type="button" class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-circle-info"></i> Details</button></a>
					</div>
      </div>
    </div>
    <?php } ?>
    ...
    <div class="card-body">
	  ...
	  <div id="product-categories">
        ...
        <ul class="list-unstyled categories-list">
			...
			<a href="<?php echo base_url('danh-muc/'.$category->id) ?>">
      ...
      <div id="product-categories">
        ...
        <ul class="list-unstyled categories-list">
			<?php foreach($brand as $key => $brand){ ?>
				...
				<a href="<?php echo base_url('thuong-hieu/'.$brand->id) ?>">
