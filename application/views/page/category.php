...
<!-- E-commerce Products Starts -->
  <div class="container">
<div class="row">
<?php foreach($category_product as $key => $catepro){ ?>
  <div class="col-md-4">
    <div class="card mb-4 box-shadow">
  <img src="<?php echo base_url('./upload/'.$catepro->image) ?>" style="height: 225px; width: 100%; display: block;" alt=""> 
	<form action="<?php echo base_url('/them-gio-hang') ?>" method="POST">
      <div class="card-body">
        <h1 class="card-text" style="color: darkorange;"><b><?php echo $catepro->title ?></b></h1>
				<input type="hidden" value="<?php echo $catepro->id ?>" name="product_id">
				<input type="hidden"  min="1" name="quantity" value="1" />
        <p class="card-text"><b>Giá: </b><?php echo number_format($catepro->price) ?> VND</p>
        ...
        <hr>
            ...
            <a href="<?php echo base_url('san-pham/'.$catepro->id.'/'.$catepro->slug) ?>"><button type="button" class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-circle-info"></i> Details</button></a>
        </div>
      </div>
    </div>
    <?php } ?>
