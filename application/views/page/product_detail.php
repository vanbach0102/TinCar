        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Chi tiết sản phẩm</h2>
              </div>
            </div>
			</div>
        </div>
      ...
      <div class="row my-2">
        ...
        <div class="col-12 col-md-5 d-flex align-items-center justify-content-center mb-2 mb-md-0">
          <div class="d-flex align-items-center justify-content-center">
            <img
			width="500px"
              src="<?php echo base_url('./upload/'.$detail->image) ?>"
        ...
        <div class="col-12 col-md-7">
          ...
          <div class="ecommerce-details-price d-flex flex-wrap mt-1">
            <h4 class="item-price me-1"><?php echo number_format($detail->price) ?> VND</h4>
          ...
          <ul class="product-features list-unstyled">
            <li><i data-feather="dollar-sign"></i> <span>Free Shipping</span></li>
            <li>
              <i data-feather="shopping-cart"></i>
              <span>Số lương: <b><?php echo $detail->quantity ?></b></span>
            </li>
			<div class="item-quantity">
                <span class="quantity-title">Qty:</span>
                <div class="quantity-counter-wrapper">
                  <div class="input-group">
                    <input type="number" class="quantity-counter" min="1" name="quantity" value="1" />
                  </div>
                </div>
              </div>
          </ul>
          ...
          <div class="d-flex flex-column flex-sm-row pt-1">
			<button class="btn btn-primary btn-cart me-0 me-sm-1 mb-1 mb-sm-0" type="submit">
            ...
            <a href="#" class="btn btn-outline-secondary btn-wishlist me-0 me-sm-1 mb-1 mb-sm-0">
              ...
              <span>Wishlist</span>
						...
						<?php }else{ ?>
							<a class="btn btn-flat-dark" role="button" href="/dang-nhap" target="_blank">Đăng nhập</a>
							<?php } ?>
...
<div class="item-features">
  ...
  <div class="row">
    ...
    <div class="col-12 mt-1" id="blogComment">
      ...
      <div class="card">
        <div class="card-body">
					<?php foreach($list_comment as $key => $list_comment){?>
          <div class="d-flex align-items-start">
            <div class="avatar me-75">
              <img width="38" height="38" alt="Avatar" src="../../../app-assets/images/portrait/small/avatar-s-9.jpg">
            </div>
            <div class="author-info">
              <h6 class="fw-bolder mb-25"><?php echo $list_comment->name ?></h6>
              <p class="card-text"><?php echo $list_comment->date ?></p>
              <p class="card-text">
							<?php echo $list_comment->comment ?>
              </p>
              <a href="#">
                <div class="d-inline-flex align-items-center">
                  <i class="font-medium-3 me-50" data-feather="corner-up-left"></i>
                  <span>Reply</span>
                </div>
              </a>
            </div>
        ...
        <div class="card-body">
          <form class="form" action="">
            <div class="row">
                  ...
                  <input type="hidden" class="product_id_comment" value="<?php echo $detail->id ?>"  >
           
            
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input  class="form-control name_comment" require  type="text" placeholder="Name">
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input class="form-control email_comment" require  type="email" placeholder="Email">
                </div>
              </div>
              <div class="col-12">
                <textarea class="form-control mb-2 comment" name="" require placeholder="Comment" rows="4"></textarea>
              </div>
              <!-- <div class="col-12">
                <div class="form-check mb-2">
                  <input class="form-check-input" id="blogCheckbox" type="checkbox">
              ...
              <div class="col-12">
                <button class="btn btn-primary write-comment" type="button">Đánh giá</button>
